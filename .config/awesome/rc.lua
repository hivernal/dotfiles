...
globalkeys = gears.table.join(
  ...
  awful.key({}, "XF86AudioMute", function()
    awful.spawn.easy_async_with_shell("pamixer -t 5 && pamixer --get-volume-human",
      function(out)
  ...
  awful.key({}, "XF86AudioRaiseVolume", function()
    ...
    awful.spawn.easy_async_with_shell("pamixer -i 5 && pamixer --get-volume-human", 
      function(out)
        widgets.volume:update(out)
      end)
  end,
  ...
  awful.key({}, "XF86AudioLowerVolume", function()
    awful.spawn.easy_async_with_shell("pamixer -d 5 && pamixer --get-volume-human",
      function(out)
        widgets.volume:update(out)
      end)
    end,
...
--[[ local function update_borders(t)
  local max = awful.layout.getname() == "max"
  local only_one = #t.screen.tiled_clients < 2
...
tag.connect_signal("property::layout", update_borders)
tag.connect_signal("property::selected", update_borders) ]]
-- }}}
awful.spawn.with_shell("lxpolkit")
awful.spawn.with_shell("feh --bg-max /home/nikita/pictures/astronavt.jpg")
